...
LIBC_LIBS = `pkg-config --cflags --libs check`  -lEGL 
LIBC_FLAGS = -I$(LIBSRC_DIR) -I$(INCLUDE_DIR) -I$(BUILD_DIR)/usr/include -L $(BUILDLIB_DIR) -L$(BUILD_DIR)/usr/lib -L $(GOPATH)/src/github.com/therecipe/env_linux_amd64_513/5.13.0/gcc_64/lib/ -I $(GOPATH)/src/github.com/therecipe/env_linux_amd64_513/5.13.0/gcc_64/include/
